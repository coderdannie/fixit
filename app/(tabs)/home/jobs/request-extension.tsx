        ...
        <View className="pt-6 pb-4">
          ...
          <JobCard
            item={{
              ...
              progress: 60,
              status: "In progress",
              currentDeadline: "21st August, 3:00pm",
              elapsedTime: "5hrs 45mins",
            }}
          />
              ...
              <View className="flex-1">
                ...
                <View className="relative">
                  ...
                  <TouchableOpacity
                    ...
                    className="absolute left-2 top-2 w-9 h-9 bg-[#E6E6E6] rounded-full items-center justify-center"
                    activeOpacity={0.7}
                  >
          ...
          {/* Checkbox */}
          <TouchableOpacity
            onPress={() => setRestartProgress(!restartProgress)}
            className="flex-row items-start gap-3 mb-6"
            activeOpacity={0.7}
          >
            <View
              className={`w-5 h-5 border-2 rounded mt-0.5 items-center justify-center ${
                restartProgress
            ...
            <Text className="text-sm text-gray-700 flex-1">
              Restart job progress after extension approval
            </Text>
          </TouchableOpacity>

          {/* Submit Button */}
          <CustomButton title="Submit Request" onPress={handleOpen} />
          <RequestSentModal
            visible={visibile}
            onClose={handleClose}
